...
const subsidioAdultosTerceiroTrimestreLicao1 = {
  cabecalho: {
    ...
    leituraDiaria: [
      { dia: "Segunda", referencia: "Atos 1.8", tema: "A virtude do Espírito Santo capacita a igreja para a missão" },
      { dia: "Terça", referencia: "Atos 11.26", tema: "Os discípulos foram chamados cristãos em Antioquia" },
      { dia: "Quarta", referencia: "Mateus 6.16-18", tema: "O jejum deve ser praticado diante de Deus" },
      { dia: "Quinta", referencia: "Isaías 61.1", tema: "O Espírito do Senhor unge e envia para anunciar boas novas" },
      { dia: "Sexta", referencia: "Atos 4.31", tema: "Cheios do Espírito, anunciavam a Palavra com ousadia" },
