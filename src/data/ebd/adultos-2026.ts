...
const subsidioAdultosTerceiroTrimestreLicao1 = {
  cabecalho: {
    ...
    leituraDiaria: [
      { dia: "Segunda", referencia: "Atos 1.8", tema: "Sem o Espírito Santo não há missão verdadeira" },
      { dia: "Terça", referencia: "Atos 11.26", tema: "A identidade e a missão caminham juntas" },
      { dia: "Quarta", referencia: "Mateus 6.16-18", tema: "O jejum fortalece nossa sensibilidade espiritual" },
      { dia: "Quinta", referencia: "Isaías 61.1", tema: "O ministério de Jesus começou pela unção do Espírito" },
      { dia: "Sexta", referencia: "Atos 4.31", tema: "A Igreja Primitiva avançava porque estava cheia do Espírito" },
      { dia: "Sábado", referencia: "Romanos 10.14,15", tema: "Como ouvirão se não há quem pregue?" },
...
const subsidioAdultosTerceiroTrimestreLicao2 = {
  cabecalho: {
    ...
    leituraDiaria: [
      { dia: "Segunda", referencia: "Atos 1:8", tema: "A missão aos gentios nasce da promessa do Espírito" },
      { dia: "Terça", referencia: "Atos 11:26", tema: "Quem é formado em Cristo vive para anunciar Cristo" },
      { dia: "Quarta", referencia: "Atos 11:20", tema: "A primeira porta que Deus usa para alcançar os gentios" },
      { dia: "Quinta", referencia: "Isaías 49:6", tema: "Deus planejou que seu povo fosse luz para as nações" },
      { dia: "Sexta", referencia: "Romanos 1:16", tema: "O Evangelho é poder de Deus para todo o ser humano" },
      { dia: "Sábado", referencia: "Atos 14:27", tema: "É Deus quem abre a porta da fé aos gentios" },
    ] as LeituraDiariaItem[],
...
const subsidioAdultosTerceiroTrimestreLicao3 = {
  cabecalho: {
    ...
    leituraDiaria: [
      { dia: "Segunda", referencia: "Atos 15:11", tema: "A salvação é afirmada como obra exclusiva da graça do Senhor Jesus" },
      { dia: "Terça", referencia: "Atos 10:44-48", tema: "Deus não faz distinção entre pessoas" },
      { dia: "Quarta", referencia: "Efésios 2:8,9", tema: "A salvação é um dom gratuito de Deus" },
      { dia: "Quinta", referencia: "Tito 2:11,12", tema: "A graça de Deus se manifestou trazendo salvação a todos" },
      { dia: "Sexta", referencia: "Hebreus 4:16", tema: "O trono da graça está aberto para o crente" },
      { dia: "Sábado", referencia: "2 Pedro 3:18", tema: "Crescendo em graça e conhecimento de Jesus Cristo" },
    ] as LeituraDiariaItem[],
