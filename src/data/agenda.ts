export interface Evento {
  ...
  titulo: string;
  horario?: string;
  banner?: string;     // caminho em /public, ex: "/eventos/mulheres-marco.jpg"
...
export const programacaoSemanal: ItemSemanal[] = [
  ...
  { dia: "Terça-feira",   titulo: "Culto",                horario: "19h30", icone: "🙏" },
  { dia: "Quarta-feira",  titulo: "Culto de Damas",       horario: "09h00", icone: "👩" },
  { dia: "Quarta-feira",  titulo: "Culto da Tarde",       horario: "15h00", icone: "🙏" },
  { dia: "Quinta-feira",  titulo: "Culto de Jovens",      horario: "19h30", icone: "🔥" },
  { dia: "Domingo",       titulo: "Escola Bíblica",       horario: "09h00", icone: "📖" },
  { dia: "Domingo",       titulo: "Culto da Noite",       horario: "18h30", icone: "🌙" },
  // Recorrentes mensais
  { dia: "1ª Segunda do mês", titulo: "Reunião de Ministério",  icone: "👥" },
  { dia: "2º Sábado",         titulo: "Santa Ceia",             icone: "🍞" },
  { dia: "3º Sábado",         titulo: "Reunião de Obreiros",    icone: "👔" },
  { dia: "4º Sábado",         titulo: "Culto com a Mocidade",   icone: "🔥" },
];
...
export const agenda2026: MesAgenda[] = [
  {
    ...
    eventos: [
      ...
      { data: "28/03", titulo: "Confraternização Dia das Mulheres", horario: "19h00", destaque: true },
  ...
  },
  {
    ...
    eventos: [
      ...
      { data: "29–30/05", titulo: "Congresso Círculo de Oração", destaque: true },
    ],
  },
  {
    mes: "Junho",
