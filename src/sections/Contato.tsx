export default function Contato() {
  return (
    <section id="contato" className="py-24 bg-[#f5f5f5]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4">
              <div className="w-10 h-10 rounded-full bg-[#ffa726] flex items-center justify-center shrink-0">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="font-semibold text-[#212121] mb-1">Telefone / WhatsApp</h4>
                <a
                  href="https://wa.me/5511916116102"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-[#424242] text-sm hover:text-[#ffa726] transition-colors"
                >
                  (11) 91611-6102
                </a>
              </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="font-semibold text-[#212121] mb-1">Horários</h4>
                <ul className="text-[#424242] text-sm space-y-1">
