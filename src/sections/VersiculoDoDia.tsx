      ...
      <Card className="overflow-hidden border border-[#ffa726]/15 bg-[#fff8ee] p-0 shadow-[0_12px_36px_rgba(0,0,0,0.05)]">
        <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="p-8 md:p-10">
            ...
            <h2 className="font-acme text-3xl md:text-5xl text-[#212121] tracking-wide mb-5">
              Palavra para hoje
            </h2>
          ...
          <div className="border-t border-black/5 bg-white/50 p-8 md:p-10 lg:border-l lg:border-t-0">
            <p className="text-[#ef5350] text-xs font-bold tracking-widest uppercase mb-3">
              Tema do dia
            </p>
            <h3 className="font-acme text-3xl text-[#212121] tracking-wide mb-5">
              {verse.tema}
            </h3>
