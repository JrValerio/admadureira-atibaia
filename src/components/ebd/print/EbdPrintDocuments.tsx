    ...
    content: (
      <>
        ...
        {topico.explicacaoBiblica?.length ? (
          <>
            <p className="text-[10px] font-semibold uppercase tracking-[0.12em] text-text-accent">
              Explicação bíblica
            </p>
        ...
        {topico.aprofundamentoDoutrinario?.length ? (
          <>
            <p className="mt-2 text-[10px] font-semibold uppercase tracking-[0.12em] text-text-accent">
