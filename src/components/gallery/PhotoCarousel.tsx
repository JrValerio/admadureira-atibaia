      ...
      >
        {images.map((image, index) => (
          <button
            ...
            className="group relative aspect-[4/3] w-[78vw] shrink-0 snap-start overflow-hidden rounded-2xl border border-black/8 bg-white text-left shadow-[0_10px_28px_rgba(0,0,0,0.08)] sm:w-[340px]"
